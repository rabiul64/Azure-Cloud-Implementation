...
namespace Ex06
{
    internal class Program
    {
        ...
        {
            Console.WriteLine("Starting Table Storage Experiment");
        ...
        public static async Task CreateDeleteTable()
        {
            ...
            Console.WriteLine("Press any key and proceed to delete.\nHint You might need to take a look at table before deleting.");
            Console.ReadKey();
        ...
        */
        ...
        public static async Task TransactionalBatchSample()
        {
            ...
            string tableName = "ex06tbl" + new Random().Next();
            string partitionKey = "partition";
            ...
            // DELETE Batch
            //
            Console.WriteLine("Deleting the table.\nHint: You might need to take a look at table if required.\nPress any key to continue.");
            Console.ReadKey();
            // Create a new batch.
